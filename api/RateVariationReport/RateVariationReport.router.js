...
const { selectRateVariation, insertComment, getCommentsbyID, insertRateVariationBulk, RateVarWithMarginDiff, ratevariationResolvedList, getResolvedComments } = require('./RateVariationReport.controller');
