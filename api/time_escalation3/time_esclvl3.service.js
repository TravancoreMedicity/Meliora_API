...
module.exports = {
    getEscalationLevel3: (data, callBack) => {
        pool.query(
            ...
            WHERE time(now()) > ADDTIME((compalint_date) , (select addtime(time(esc_lvl3) ,time(esc_time_limit) ) as escalation from co_time_escalation
