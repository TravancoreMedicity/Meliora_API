...
module.exports = {
    getEscalationLevel4: (data, callBack) => {
        pool.query(
            ...
            WHERE time(now()) > ADDTIME((compalint_date) , (select addtime(time(esc_lvl4) ,time(esc_time_limit) ) as escalation from co_time_escalation
