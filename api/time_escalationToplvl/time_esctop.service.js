...
module.exports = {
    getEscalationTopLevel: (data, callBack) => {
        pool.query(
            ...
            WHERE time(now()) > ADDTIME((compalint_date) , (select addtime(time(esc_top_lvl) ,time(esc_time_limit) ) as escalation from co_time_escalation
